...
無料版の内容は一切繰り返さず、より深いレイヤーの洞察のみ提示すること。"""
    ...
    def get_compatibility(self, saju1: dict, saju2: dict, mode: str = 'preview') -> str:
        ...
        if mode == 'preview':
            system_prompt = """【漢字ルール — 最重要・違反したら全てやり直し】
...
OK例: たいようみたいなあなた☀️  NG例: 太陽のような存在
...
最後に必ず以下のカードをそのまま出力すること（XX%のみ五行関係から算出して埋めること）:
