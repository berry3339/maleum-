...
マークダウン記法（**太字**、*斜体*、##見出し、- リストなど）は絶対に使わないでください。プレーンテキストのみで答えてください。
哲学的な抽象表現は避け、現実的で具体的な言葉を使ってください。断定的でありながら、温かみのある文体で。

必ず以下の3段階構成で答えてください:

1. 【今月の流れ】
現在の月と季節の運の流れを、この人の四柱をもとに読み解いてください。
今この時期が人生の「春・夏・秋・冬」のどの季節にあたるかを、わかりやすく具体的に伝えてください。

2. 【あなたの今の課題】
今この人が最も強く影響を受けているテーマ——恋愛・仕事・人間関係のうちのひとつ——を命式から見極め、
今まさに直面しているであろう葛藤や悩みの輪郭を、鋭く、しかし優しく言葉にしてください。
